...
const SMART_SUMMARIES = {
  driver: [
    "Professional driver with {exp} years of experience operating heavy/commercial vehicles safely across urban and highway routes. Holds a valid commercial license with a clean driving record. Known for punctuality, route optimization, and excellent vehicle maintenance practices.",
    "Experienced driver committed to safe, on-time delivery and passenger satisfaction. Skilled in GPS navigation, traffic management, and vehicle upkeep. {exp} years of accident-free driving in diverse conditions.",
  ],
  teacher: [
    "Dedicated educator with {exp} years of classroom experience teaching {subject} to students aged {age}. Passionate about creating engaging, inclusive learning environments. Skilled in curriculum development, student assessment, and parent communication.",
    "Enthusiastic teacher with a proven track record of improving student outcomes in {subject}. Experienced in differentiated instruction, technology integration, and fostering critical thinking skills.",
  ],
  engineer: [
    "Results-driven software engineer with {exp}+ years building scalable systems using {skills}. Track record of delivering high-quality code on time. Strong problem-solver with experience in full-stack development, system design, and cross-functional collaboration.",
    "Full-stack engineer skilled in {skills}. Passionate about clean architecture, performance optimization, and developer experience. {exp} years of experience shipping production-grade applications.",
  ],
  doctor: [
    "Dedicated medical professional with {exp} years of clinical experience in {specialty}. Committed to evidence-based patient care, accurate diagnosis, and compassionate treatment. Strong background in patient education and multidisciplinary team collaboration.",
  ...
  designer: [
    "Creative designer with {exp} years crafting visually compelling experiences across digital and print. Proficient in {skills}. Blends aesthetic sensibility with user-centered thinking to deliver solutions that are both beautiful and functional.",
    "UX/UI designer with a portfolio spanning mobile apps, web platforms, and brand identities. {exp} years of experience translating user needs into elegant, conversion-driven designs. Skilled in {skills}.",
  ],
  manager: [
    "Strategic leader with {exp} years managing cross-functional teams and delivering projects on time and budget. Skilled in stakeholder communication, performance management, and process optimization. Known for building high-performing teams.",
    "Operations manager with {exp} years of experience driving organizational efficiency and team performance. Adept at data-driven decision making, budget management, and change leadership.",
  ],
  accountant: [
    "Detail-oriented accountant with {exp} years managing financial records, tax compliance, and reporting for organizations across industries. Proficient in {skills}. Known for accuracy, efficiency, and integrity.",
    "Certified accounting professional with expertise in {skills}. {exp} years of experience in financial analysis, audit preparation, and budget planning. Strong analytical mindset with meticulous attention to detail.",
  ],
  lawyer: [
    "Experienced attorney with {exp} years practicing {specialty} law. Skilled in legal research, contract drafting, client counsel, and courtroom advocacy. Known for strategic thinking and delivering favorable outcomes.",
    "Results-oriented legal professional with expertise in {specialty}. {exp} years advising clients on complex legal matters with a focus on practical, cost-effective solutions.",
  ],
  nurse: [
    "Compassionate registered nurse with {exp} years of clinical experience in {specialty}. Skilled in patient assessment, medication administration, and care coordination. Committed to delivering safe, holistic patient care.",
    "Dedicated nursing professional with {exp} years working in {specialty} settings. Strong clinical judgment, excellent communication skills, and a patient-first approach to care delivery.",
  ],
  default: [
    "Results-driven professional with {exp}+ years of experience in {field}. Demonstrated ability to deliver exceptional outcomes through strategic thinking and collaborative approach. Passionate about continuous learning and making measurable impact.",
    "Dedicated {field} professional with a proven track record of {achievement}. Strong communicator, team player, and problem-solver with {exp} years of hands-on experience.",
  ],
};
...
function detectCategory(role = "") {
  ...
  if (
    /engineer|developer|programmer|coder|architect|devops|fullstack|frontend|backend/.test(
      r
    )
  )
    return "engineer";
  if (/doctor|physician|medical|surgeon|clinic|psychiatr|pediatr/.test(r))
    return "doctor";
  if (/design|ui|ux|graphic|visual|creative/.test(r)) return "designer";
  if (/manager|director|head|chief|lead|supervisor|vp|president/.test(r))
    return "manager";
...
function generateSmartSummary(data) {
  ...
  const skillArr = data.skills
    ...
    .filter(Boolean);
  const expYears =
    data.experience.length > 0 ? Math.max(1, data.experience.length * 2) : 3;
  return tpl
    .replace(/{exp}/g, expYears)
    .replace(
      /{skills}/g,
      skillArr.slice(0, 4).join(", ") || "industry-leading tools"
    )
...
function generateSmartBullets(role = "", company = "") {
  ...
  const bullets = {
    engineer: [
      `• Built and maintained scalable ${
        role.includes("frontend") ? "UI components" : "backend services"
      } at ${company || "the company"}, improving performance by 30%.`,
      `• Collaborated with cross-functional teams to define, design, and ship new features.`,
      `• Reduced technical debt by refactoring legacy code, cutting bug reports by 25%.`,
      `• Mentored junior developers and conducted code reviews to maintain quality standards.`,
    ],
    manager: [
      `• Led a team of 8+ professionals at ${
        company || "the organization"
      }, achieving 120% of quarterly targets.`,
      `• Designed and implemented process improvements that reduced operational costs by 18%.`,
      `• Managed stakeholder relationships across departments, improving cross-team collaboration.`,
      `• Oversaw budget planning and resource allocation for projects exceeding ₹50L in value.`,
    ],
    teacher: [
      `• Designed and delivered engaging lesson plans for a class of 35+ students at ${
        company || "the institution"
      }.`,
      `• Improved student assessment scores by 22% through differentiated instruction techniques.`,
      `• Implemented technology-based learning tools that increased student participation.`,
      `• Maintained regular communication with parents, ensuring student progress and support.`,
    ],
    driver: [
      `• Safely transported passengers/goods across designated routes with 100% punctuality record.`,
      `• Maintained vehicle cleanliness and performed daily safety inspections before each shift.`,
      `• Navigated efficiently using GPS tools, reducing average route time by 15%.`,
      `• Completed all deliveries on schedule with zero reported accidents or complaints.`,
    ],
    default: [
      `• Delivered key projects on time and within budget at ${
        company || "the organization"
      }, contributing to team goals.`,
      `• Identified inefficiencies in existing workflows and implemented solutions that saved 20% time.`,
      `• Collaborated with cross-functional teams to drive organizational objectives.`,
      `• Recognized for consistent performance and promoted within the first year.`,
    ],
  };
...
function ResumeDocument({ data, tpl, docFormat }) {
  ...
  const sk = skills
    ...
    .map((s) => s.trim())
    .filter(Boolean);
  const cl = [personal.email, personal.phone, personal.location].filter(
    Boolean
  );
  ...
  const EduBlock = ({ e }) => (
    <div style={{ marginBottom: "0.75em" }}>
      ...
      <div
        style={{ fontSize: "0.92em", color: tpl.accent, fontFamily: tpl.font }}
      >
        {e.school}
        {e.date ? ` · ${e.date}` : ""}
        {e.grade ? ` · ${e.grade}` : ""}
  ...
  const extras = (
    <>
      ...
      {languages && (
        <Sec title="Languages">
          <div
            style={{ fontSize: "0.92em", color: "#444", fontFamily: tpl.font }}
          >
            {languages}
          </div>
        </Sec>
  ...
  const photoEl = personal.photo ? (
    <img
      ...
      style={{
        ...
        objectFit: "cover",
        borderRadius: "50%",
        border: `0.2em solid ${tpl.accent}`,
        flexShrink: 0,
      }}
    />
  ) : null;
  const sidePhotoEl = personal.photo ? (
    <img
      src={personal.photo}
      alt=""
      style={{
        ...
        objectFit: "cover",
        borderRadius: "50%",
        border: `0.2em solid ${tpl.accent}55`,
        display: "block",
        margin: "0 auto 1em",
      }}
    />
      ...
      <div style={{ ...wrapperStyle, padding: "3.4em 4em" }}>
        <div
          style={{
            display: "flex",
            alignItems: "center",
            gap: personal.photo ? "1.7em" : 0,
            paddingBottom: "1.4em",
            borderBottom: `0.2em solid ${tpl.accent}`,
            marginBottom: "1.5em",
          }}
        >
          {photoEl}
    ...
    return (
      <div style={{ ...wrapperStyle, display: "flex" }}>
        <div
          style={{
            width: "19em",
            background: tpl.sidebar,
            color: "#fff",
            padding: "2.15em 1.4em",
            flexShrink: 0,
          }}
        >
          {sidePhotoEl}
          ...
          <div
            style={{
              ...
              borderTop: `1px solid ${tpl.accent}44`,
              paddingTop: "0.9em",
              marginBottom: "1.2em",
            }}
          >
            ...
            <div style={{ marginBottom: "1.2em" }}>
              <div
                style={{
                  ...
                  textTransform: "uppercase",
                  color: tpl.accent,
                  borderBottom: `1px solid ${tpl.accent}55`,
                  paddingBottom: "0.2em",
                  marginBottom: "0.6em",
                  fontWeight: 700,
                }}
    ...
    <div style={{ ...wrapperStyle, padding: "3.4em 4em" }}>
      ...
      >
        ...
        <div style={{ flex: 1 }}>
          ...
          {lk.length > 0 && (
            <div
              style={{ fontSize: "0.85em", color: "#888", marginTop: "0.15em" }}
            >
              {lk.join("  ·  ")}
            </div>
          )}
...
export default function App() {
  ...
  const [data, setData] = useState({
    ...
    education: [
      { id: 1, school: "", degree: "", field: "", date: "", grade: "" },
    ],
    skills: "",
    achievements: "",
    languages: "",
  ...
  const goldStars = useMemo(
    () =>
      Array.from({ length: 80 }, (_, i) => ({
        ...
        x: Math.random() * 100,
        y: Math.random() * 100,
        size: Math.random() < 0.12 ? 2.5 : Math.random() < 0.35 ? 1.8 : 1,
        delay: Math.random() * 7,
        dur: 2.5 + Math.random() * 4,
        opacity: Math.random() < 0.08 ? 1 : 0.35 + Math.random() * 0.5,
      })),
    []
  );
  ...
  const applyCrop = () => {
    ...
    img.onload = () => {
      ...
      const renderedW =
        img.naturalWidth *
        photoScale *
        (DISPLAY / Math.max(img.naturalWidth, img.naturalHeight));
      const renderedH =
        img.naturalHeight *
        photoScale *
        (DISPLAY / Math.max(img.naturalWidth, img.naturalHeight));
      ...
      >
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(ellipse,rgba(200,169,81,.055) 0%,transparent 60%)",
        ...
        {goldStars.map((st) => (
          <div
            ...
            style={{
              ...
              height: st.size,
              borderRadius: "50%",
              background: `rgba(200,169,81,${st.opacity})`,
              animation: `twinkle ${st.dur}s ease-in-out infinite ${st.delay}s`,
              boxShadow: st.size > 2 ? `0 0 5px rgba(200,169,81,.5)` : "none",
            }}
          />
        ))}
        {whiteStars.map((st) => (
      ...
      >
          ...
          >
            <div
              style={{
                ...
                borderRadius: "50%",
                background:
                  "linear-gradient(180deg, rgba(200,169,81,0.1) 0%, transparent 100%)",
            ...
            >
              Answer a few simple questions. Let our intelligent engine
              structure, format, and design your professional career.
            </p>
            <button
              className="btn-primary"
        ...
        {step === 1 && (
          <div className="fade-in">
            <h2 style={{ fontSize: 26, marginBottom: 8, fontWeight: 600 }}>
              Personal Details
            </h2>
            <p
              style={{
            ...
            >
              Let recruiters know who you are and how to reach you.
            </p>
            ...
            >
              ...
              >
                {data.personal.photo ? (
                  ...
                  <ImageIcon size={24} color="var(--sq-gold)" />
                )}
              </div>
              <div style={{ flex: 1 }}>
                <input
            ...
            <div className="card">
              ...
              <input
                ...
                onChange={(e) => upP("role", e.target.value)}
              />
              ...
              <input
                ...
                onChange={(e) => upP("location", e.target.value)}
              />
            </div>
            ...
            <div className="card">
              ...
              >
                ...
                <button
                  className="btn-ghost"
                  onClick={() => upP("summary", generateSmartSummary(data))}
                >
                  <Sparkles size={14} /> Smart Write
                </button>
              </div>
              <textarea
                className="input-field"
        ...
        {step === 2 && (
          <div className="fade-in">
            ...
            >
              Add your most relevant professional experience.
            </p>
                ...
                <div className="grid-2">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={exp.date}
                      onChange={(e) => updExp(exp.id, "date", e.target.value)}
                    />
                  </div>
                </div>
                <div
                  ...
                  <button
                    ...
                    onClick={() =>
                      updExp(
                        exp.id,
                        "desc",
                        generateSmartBullets(exp.role, exp.company)
                      )
                    }
                  >
                    <Sparkles size={14} /> Smart Bullets
                  </button>
                </div>
                <textarea
                  className="input-field"
                  ...
                  value={exp.desc}
                  onChange={(e) => updExp(exp.id, "desc", e.target.value)}
                />
              </div>
            ))}
            <button
            ...
            {data.education.map((edu, index) => (
              <div className="card" key={edu.id}>
                ...
                >
                  ...
                  >
                    Degree {String(index + 1).padStart(2, "0")}
                  </span>
                ...
                <div className="grid-2">
                  <div>
                    ...
                    <input
                      ...
                      value={edu.date}
                      onChange={(e) => updEdu(edu.id, "date", e.target.value)}
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      value={edu.grade}
                      onChange={(e) => updEdu(edu.id, "grade", e.target.value)}
                    />
                  </div>
                </div>
              </div>
          ...
          <div className="fade-in">
            ...
            <div className="card">
              ...
              >
                ...
                <button
                  ...
                  onClick={() => {
                    const suggestions = {
                      engineer:
                        "JavaScript, React, Node.js, Python, SQL, REST APIs, Git, Docker, AWS, Agile",
                      teacher:
                        "Curriculum Design, Classroom Management, Assessment, Communication",
                      driver:
                        "Commercial License, GPS Navigation, Route Planning, Safety Compliance",
                      manager:
                        "Team Leadership, Project Management, Budgeting, Agile, PMP",
                      designer:
                        "Figma, Adobe XD, Illustrator, Photoshop, UX Research",
                      default:
                    ...
                    setData((d) => ({
                      ...d,
                      skills:
                        suggestions[detectCategory(data.personal.role)] ||
                        suggestions.default,
                    }));
                  }}
                >
              ...
              <textarea
                className="input-field"
                rows={6}
                placeholder="Comma separated. E.g. React, Node.js, Agile, Python"
                value={data.skills}
                onChange={(e) =>
              ...
              >
                Every skill separated by a comma will appear as a badge.
              </p>
            </div>
        ...
        {step === 5 && (
          <div className="fade-in">
            ...
            >
              Stand out with certifications, languages, or awards.
            </p>
            <div className="card">
              <label className="label" style={{ marginTop: 0 }}>
                Languages
              ...
              <input
                ...
                onChange={(e) =>
                  setData((d) => ({ ...d, languages: e.target.value }))
                }
              />
              ...
              <textarea
                ...
                onChange={(e) =>
                  setData((d) => ({ ...d, achievements: e.target.value }))
                }
              />
            </div>
            <BottomNav
      ...
      {(step === 6 || showPreview) && (
        ...
        >
            ...
            >
              <button
                ...
                onClick={() =>
                  setDocFormat((f) => ({
                    ...f,
                    fontSize: Math.max(10, f.fontSize - 1),
                  }))
                }
              >
                <ZoomOut size={16} />
              ...
              <button
                ...
                onClick={() =>
                  setDocFormat((f) => ({
                    ...f,
                    fontSize: Math.min(20, f.fontSize + 1),
                  }))
                }
              >
                <ZoomIn size={16} />
            ...
            >
              {[
                ...
                <button
                  key={a}
                  className="btn-ghost"
                  onClick={() => setDocFormat((f) => ({ ...f, align: a }))}
                  style={{
                    background:
                      docFormat.align === a
                        ? "rgba(200,169,81,0.1)"
          ...
          >
            ...
            >
              <Palette size={18} color="var(--sq-gold)" />{" "}
              <span style={{ marginLeft: 8, color: "var(--gh-text)" }}>
                Design
              </span>
            </button>
            <div
            ...
            {showPreview && step < 6 ? (
              <button
                className="btn-primary"
                style={{ borderRadius: 40, padding: "12px 28px" }}
                onClick={() => setShowPreview(false)}
              >
                <Edit3 size={18} />{" "}
                <span style={{ marginLeft: 8 }}>Back to Edit</span>
              </button>
            ) : (
              <button
                className="btn-primary"
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              borderRadius: "50%",
              overflow: "hidden",
              border: `3px solid var(--sq-gold)`,
              position: "relative",
              cursor: photoDragging ? "grabbing" : "grab",
              boxShadow: "0 0 50px rgba(200,169,81,0.2)",
              flexShrink: 0,
              userSelect: "none",
              touchAction: "none",
            }}
            ...
            onWheel={(e) => {
              ...
              setPhotoScale((s) =>
                parseFloat(
                  Math.max(0.3, Math.min(3.5, s - e.deltaY * 0.003)).toFixed(3)
                )
              );
            }}
          ...
          >
            {photoPreview && (
              <img
                ...
                style={{
                  position: "absolute",
                  width: `${100 * photoScale}%`,
                  height: `${100 * photoScale}%`,
                  objectFit: "cover",
                  left: `calc(50% + ${offsetDisplay.x}px)`,
                  top: `calc(50% + ${offsetDisplay.y}px)`,
                  transform: "translate(-50%,-50%)",
                  userSelect: "none",
                  pointerEvents: "none",
                  maxWidth: "none",
          ...
          >
            <button
              onClick={() =>
                setPhotoScale((s) =>
                  parseFloat(Math.max(0.3, s - 0.08).toFixed(3))
                )
              }
              className="btn-ghost"
              style={{
            ...
            <input
              ...
              style={{ width: 200, accentColor: "var(--sq-gold)" }}
            />
            <button
              onClick={() =>
                setPhotoScale((s) =>
                  parseFloat(Math.min(3.5, s + 0.08).toFixed(3))
                )
              }
              className="btn-ghost"
              style={{
            ...
            >
              {TEMPLATES.map((t) => (
                <div
                  ...
                  style={{
                    border: `2px solid ${
                      tpl.id === t.id ? "var(--sq-gold)" : "var(--gh-border)"
                    }`,
                    borderRadius: 12,
                    padding: 10,
                    cursor: "pointer",
                    background: "var(--gh-bg)",
                    transition: "all 0.2s",
                    transform: tpl.id === t.id ? "translateY(-2px)" : "none",
                    boxShadow:
                      tpl.id === t.id
                        ? "0 8px 20px rgba(200,169,81,0.15)"
                        : "none",
                  }}
                >
                  <div
                    style={{
                      height: 80,
                      borderRadius: 6,
                      background: `linear-gradient(135deg, ${t.sidebar} ${
                        t.layout === "sidebar" ? "35%" : "55%"
                      }, ${t.accent})`,
                      marginBottom: 12,
                    }}
                  ></div>
